...
#define ADD_INT(p, x) \
	...
	{
		if(m_NetServer.MaxClients() <= VANILLA_MAX_PLAYER)
		{
	...
	{
		if(ClientCount >= VANILLA_MAX_PLAYER)
		{
			if(ClientCount < MaxClients)
				ClientCount = VANILLA_MAX_PLAYER - 1;
			else
				ClientCount = VANILLA_MAX_PLAYER;
		}
		if(MaxClients > VANILLA_MAX_PLAYER)
			MaxClients = VANILLA_MAX_PLAYER;
	...
	case SERVERINFO_VANILLA: Remaining = VANILLA_MAX_PLAYER; break;
	case SERVERINFO_INGAME: Remaining = VANILLA_MAX_PLAYER; break;
