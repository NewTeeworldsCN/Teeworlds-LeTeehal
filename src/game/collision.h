...
public:
	...
	int GetTileReserved(int Tx, int Ty) const;
	int GetHazardAt(vec2 Pos) const;
	int GetHazardAtCharacter(vec2 Pos) const;
	int GetFacilityRoomAt(vec2 Pos) const;
	void ClearHazardAt(vec2 Pos);
